...
module Tapyrus
  module SLIP39
    ...
    class SSS
      ...
      #   identifier. Shares generated by tapyrus-ruby 0.4.0 and earlier need this to be recovered.
      ...
      #   two bytes, so a salt built this way only matches shares generated by tapyrus-ruby 0.4.0 and earlier.
      # @return [String] salt with binary format.
      def self.get_salt(id, legacy = false)
        identifier = legacy ? id.itb : [id].pack("n")
        (Tapyrus::SLIP39::CUSTOMIZATION_STRING.pack("c*") + identifier)
      end
