...
describe Schnorr do
  ...
  describe 'end to end schnorr' do
    it 'should generate and verify' do
      ...
      expect(Schnorr.valid_sig?(msg, public_key, signature)).to be true

      signature[SecureRandom.random_number(6)] = (1 + SecureRandom.random_number(255)).to_s(16).htb
      expect(Schnorr.valid_sig?(msg, public_key, signature)).to be false
    end
  end
  ...
  describe 'compact schnorr' do
    it 'should be passed.' do
      ...
      expect(Schnorr.valid_sig?(message, pubkey, sig)).to be true
      ...
      expect(Schnorr.valid_sig?(message, pubkey, sig)).to be false
