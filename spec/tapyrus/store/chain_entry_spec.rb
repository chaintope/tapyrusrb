...
describe Tapyrus::Store::ChainEntry do
  ...
  describe '#to_payload' do
    it 'should be parsed' do
      header = Tapyrus::BlockHeader.parse_from_payload('0000002021db4eba7c84958483205b6cdda9192bc42069c2a78143497283253200000000c420e732f0c35c2e2375ef41c247cece722dc87382d1a5f0f18854e9973b4846518bdc59ffff001dea3dba3d'.htb)
      entry1 = Tapyrus::Store::ChainEntry.new(header, 1209901)
      ...
      header2 = Tapyrus::BlockHeader.parse_from_payload('0100000043497fd7f826957108f4a30fd9cec3aeba79972084e90ead01ea330900000000bac8b0fa927c0ac8234287e33c5f74d38d354820e24756ad709d7038fc5f31f020e7494dffff001d03e4b672'.htb)
  ...
  describe '#parse_from_payload' do
    it 'should be parsed' do
      entry1 = Tapyrus::Store::ChainEntry.parse_from_payload('032d76120000002021db4eba7c84958483205b6cdda9192bc42069c2a78143497283253200000000c420e732f0c35c2e2375ef41c247cece722dc87382d1a5f0f18854e9973b4846518bdc59ffff001dea3dba3d'.htb)
      ...
      entry2 = Tapyrus::Store::ChainEntry.parse_from_payload('01010100000043497fd7f826957108f4a30fd9cec3aeba79972084e90ead01ea330900000000bac8b0fa927c0ac8234287e33c5f74d38d354820e24756ad709d7038fc5f31f020e7494dffff001d03e4b672'.htb)
