...
describe Tapyrus::BloomFilter do
  ...
  describe "#insert" do
    ...
    context "with tweak" do
      subject { Tapyrus::BloomFilter.create_filter(3, 0.01, 2_147_483_649) }
      it do
        subject.add("99108ad8ed9bb6274d3980bab5a85c048f0950c8".htb)
        subject.add("b5a2c786d9ef4658287ced5914b37a1b4aa32eee".htb)
        subject.add("b9300670b4c5366e95b2699e8b18bc75e5f729c5".htb)
    ...
    context "add key", network: :prod do
      ...
      it do
        ...
        subject.add(Tapyrus.hash160(key.pubkey).htb)
