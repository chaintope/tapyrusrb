...
describe Tapyrus::Message::Version do
  ...
  describe 'to_pkt' do
    ...
    it 'should generate pkt' do
      expect(subject.bth).to eq('0b11090776657273696f6e000000000067000000b4b868867f1101000000000000000000cf31455900000000080000000000000000000000000000000000ffff7f000001479d080000000000000000000000000000000000ffff7f000001479d40abec703bf6eeba112f7461707972757372623a302e312e302f0000000000')
    end
  end
