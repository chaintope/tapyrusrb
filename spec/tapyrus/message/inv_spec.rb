...
describe Tapyrus::Message::Inv do
  ...
  describe 'parse' do
    subject {
      Tapyrus::Message::Inv.parse_from_payload('0201000000099c332dc6d71c968a3f47d6ffd43436062c72dad477b515ce2e108e1e6f109601000000e6cf87650476e8677543885e388761f09c732e66d479501f9d9c19cdb2b50e05'.htb)
    }
    it do
