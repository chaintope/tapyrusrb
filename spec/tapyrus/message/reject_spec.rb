...
describe Tapyrus::Message::Reject do
  ...
  describe 'parse from payload' do
    subject {
      Tapyrus::Message::Reject.parse_from_payload('0274781008636f696e62617365b593848d99f41a45e9d29054993139f0582025bb45191986bc0d81327fc4ed4e'.htb)
    }
  ...
  describe 'to_pkt' do
    subject {
      Tapyrus::Message::Reject.new('tx', Tapyrus::Message::Reject::CODE_INVALID,
