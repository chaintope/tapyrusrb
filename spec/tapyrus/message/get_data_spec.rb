...
describe Tapyrus::Message::GetData do
  describe "parse" do
    subject do
      Tapyrus::Message::GetData.parse_from_payload(
        "0201000000099c332dc6d71c968a3f47d6ffd43436062c72dad477b515ce2e108e1e6f109601000000e6cf87650476e8677543885e388761f09c732e66d479501f9d9c19cdb2b50e05".htb
      )
    end
    it do
  ...
  describe "to_pkt" do
    subject do
      ...
      inv.inventories << Tapyrus::Message::Inventory.new(
        1,
        "099c332dc6d71c968a3f47d6ffd43436062c72dad477b515ce2e108e1e6f1096"
      )
      inv.inventories << Tapyrus::Message::Inventory.new(
        1,
        "e6cf87650476e8677543885e388761f09c732e66d479501f9d9c19cdb2b50e05"
      )
      inv.to_pkt
    end
    it do
