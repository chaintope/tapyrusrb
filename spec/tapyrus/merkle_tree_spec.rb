...
describe Tapyrus::MerkleTree do
  describe "build merkle tree" do
    subject do
      ...
      Tapyrus::MerkleTree.build_from_leaf(tx_hashes)
    end
  ...
  describe "build partial merkle tree" do
    context "not include tx" do
      subject do
        ...
        Tapyrus::MerkleTree.build_partial(37, hashes, Tapyrus.byte_to_bit("00".htb))
      end
      it "should be build" do
    ...
    context "include coinbase tx only" do
      subject do
        ...
        Tapyrus::MerkleTree.build_partial(1, hashes, Tapyrus.byte_to_bit("01".htb))
      end
      it "should be build" do
        expect(subject.merkle_root).to eq("36a39ed285a4ffdb141c16af1eb1029bf18a18a7fdc54c70561d9371714f0c74")
      end
    ...
    context "include tx" do
      subject do
        ...
        Tapyrus::MerkleTree.build_partial(7, hashes, Tapyrus.byte_to_bit("1d".htb))
      end
      it "should be build" do
  ...
  describe "find_node" do
    ...
    context "find final txid in tree which has odd number of txids" do
      let(:tree) do
        hashes = %w[
          eabc5a0f2db047073fd8bcc8317b72578f705a0845b33d3c0fa939421219a452
          15157a0138efe2d76ca0ef26f4b42341bd14ff2871603e7364a1d404da51493f
        ]
        Tapyrus::MerkleTree.build_partial(3, hashes, Tapyrus.byte_to_bit("1d".htb))
      end
