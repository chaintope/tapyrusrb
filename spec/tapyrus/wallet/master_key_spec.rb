...
describe Tapyrus::Wallet::MasterKey do
  ...
  describe '#parse_from_payload, #to_payload' do
    subject { Tapyrus::Wallet::MasterKey.parse_from_payload('0110f9d75d45f59a9e07a7b6331a58ceedd740a262d6fb6122ecf45be09c50492b31f92e9beb7d9a845987a02cefda57a15f9c467a17872029a9e92299b5cbdf306e3a0ee620245cbd508959b6cb7ca637bd55'.htb) }
  ...
  describe '#encrypt, #decrypt' do
    it 'should be process' do
      passphrase = 'hogehoge'
      key = Tapyrus::Wallet::MasterKey.new('a262d6fb6122ecf45be09c50492b31f92e9beb7d9a845987a02cefda57a15f9c467a17872029a9e92299b5cbdf306e3a0ee620245cbd508959b6cb7ca637bd55')
  ...
  describe '#derive' do
    ...
    it 'should derive child key using path.' do
      expect(subject.derive("m/84'/0'/0'/0/0").to_base58).to eq('vprv9PWf8opM7jMHZicbJtr7E7cVTCGRf7Q5JXpeD7t7oxMVdMDT1XXxJdacknPVLhM17iCnyCGsun8s9hqrCb5FBdyXTa15xasKRh5rrVZysDJ')
      expect(subject.derive("m/84'/0'/0'/0/1").to_base58).to eq('vprv9PWf8opM7jMHbu7Sybs4CafvwY2iv2QHzqgBVRqPn78ZtQTFDs6TkuUdwrAwWewFENPmAqR1MNi3rz993NLx9wBbhMw15EMimanNmMs7zut')
      expect(subject.derive("m/84'/0'/0'/1/0").to_base58).to eq('vprv9Q3pihpk5z42ccjrpVemVD5J1uRzGBNF6RJd3CZ7qpjwnQ5vrjQ1kcSbWpkznPQ2KwMiTs6pRGBNJCKMRaf6ZyCg6s25smxwnGB7NMARf8S')
      expect(subject.derive("m/44'/0'/0/0'/1").to_base58).to eq('tprv8kKYBSrNjXJo4EeTudQL5eFSQebFcWi4YtLX4mpqYYBaFYuXoDPFWJTbjWJX9rK4D9ceYm4ZoKFc9AiTfHKWsob9z3GBjDdVZkfThwEuLDD')
      expect(subject.derive("m/44'/1/0'/0/1'").to_base58).to eq('tprv8kEZgVRKpjG75bCKWBxhaYcpqfd4BZN4THGjwr9MQo3rRKXzMoBpV7mPAAQb6rTFddvVc1fdx9j3KCGnJRMEASziMVrxj4hV58YrnVzWa1J')
