...
describe Tapyrus::BlockHeader do
  subject do
    Tapyrus::BlockHeader.parse_from_payload(
      ''
        .htb
    )
  end
  ...
  describe 'parse from payload' do
    it 'should be parsed' do
      ...
      expect(subject.proof).to eq(
        '742dd09cab068bd26fd83d1c1a066405026ccc86bfc5c562350832f78fcd837f6b2ba890c7af950aa1adb40f75834da3c3c4075697c9c938dae1e745114e559c'
      )
  ...
  describe '#valid_timestamp?' do
    before { Timecop.freeze(Time.utc(2017, 9, 22, 15, 13, 25)) }
